...
public abstract class Connection{
    ...
    public void setEndTime(double endTime) {
        System.out.println("%%%%%%%%%%%%%%%%%endTime："+endTime+"+startime:"+this.startTime);
	...
	public String toString() {
        ...
        public void statechange(double time){
...
//            }
    ...
    public double gettime(){
        ...
        this.connTime=this.endTime-this.startTime;
        System.out.println("%%%%%%%%%%%%%%%%%this.conTime："+this.connTime+"="+this.endTime+"-"+this.startTime);
